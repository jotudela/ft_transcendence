		...
		<div class="h-screen flex items-center justify-center">
			<div class="bg-gray-900 bg-opacity-20 border border-gray-500 border-opacity-40 rounded-xl p-10 backdrop-blur-md shadow-xl w-full max-w-md text-center">
				...
				<img src="/assets/avatar.png" 
					 ...
					 class="w-24 h-24 mx-auto rounded-full mb-4 border-4 border-sky-500"/>
 ...
 *                           Login Player 2
 *========================================================================**/
function renderPlayer2Login(player1Name, user1Id) {
    const app = document.getElementById("app");
    if (!app)
        return;
    app.innerHTML = `
 ...
 *                           Choix lvl avec ID
 *========================================================================**/
function renderLvl(name, user1Id) {
    const app = document.getElementById("app");
    if (!app)
        return;
    app.innerHTML = `
    ...
    document.getElementById("medium")?.addEventListener("click", (e) => {
        e.preventDefault();
        history.pushState({ page: "medium" }, "", "/medium");
